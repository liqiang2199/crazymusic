...
//            notifyDataSetChanged();
     ...
     * @param object
     */
    public void insertData(int type, int index, Object object) {
        try {
            this.list.get(type).getList().add(index, object);
            notifyDataSetChanged();
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @param object
     */
    public void updateData(int type, int index, Object object) {
        try {
            this.list.get(type).getList().set(index, object);
            Log.i("TAG", "updateData: " + index);
